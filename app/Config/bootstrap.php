 ...
 *
 */
Configure::write('Tweet.types', array('favorites' => 'favoris', 'user_timeline' => 'tweets'));
Configure::write('Config.language', 'fr');
Configure::write('App.title', 'Développeur Angers - Emmanuel Pelletier développeur web');
Configure::write('App.description', "Site d'Emmanuel Pelletier, jeune développeur sur Angers qui aime, entre autres, le web mobile, CakePHP et Android");
/**
